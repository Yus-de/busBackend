...
router.post('/verify-otp', verifyOtpLimiter, validate(verifyEmailSchema), authController.verifyOTP);
router.post('/verify-email', verifyOtpLimiter, validate(verifyEmailSchema), authController.verifyEmail);
